...
const MOCK_TOURS: NewTour[] = [
  ...
  {
    title: 'Jaipur Private Full-Day City Tour',
    slug: 'jaipur-private-full-day-city-tour',
    description:
      'A private, guide-led day tour of Jaipur covering Amber Fort, City Palace, Hawa Mahal and Jantar Mantar, plus the Pink City’s best bazaars and local food.',
    longDescription:
      'See the very best of the Pink City in a single, well-paced day with a government-approved local guide. Begin at the hilltop Amber Fort, explore the royal City Palace and the astronomical wonders of Jantar Mantar (a UNESCO World Heritage Site), photograph the iconic Hawa Mahal, and finish in Johari and Bapu Bazaar for textiles, jewellery and authentic Rajasthani snacks. Ideal for travellers short on time or arriving on a Golden Triangle trip who want depth, context and honest local tips rather than a rushed group tour.',
    duration: 1,
    price: '2999',
    maxGroupSize: 6,
    category: 'city',
    ...
    highlights: [
      '🏰 Skip-the-hassle guided visit to Amber Fort',
      '👑 Explore City Palace & royal courtyards',
      '📸 Photo stop at the iconic Hawa Mahal',
      '🔭 Jantar Mantar UNESCO observatory',
      '🛍️ Local bazaar & street-food walk',
    ],
    included: [
      'Private air-conditioned car',
      'Government-approved local guide (full day)',
      'Bottled water',
      'Pickup & drop at your Jaipur hotel',
    ],
    excluded: [
      'Monument entry fees',
      'Lunch & personal expenses',
    ...
    itinerary: [
      { day: 1, title: 'Jaipur Highlights in a Day', description: 'Full-day private guided tour of the Pink City.', activities: ['Hotel pickup', 'Amber Fort', 'City Palace', 'Jantar Mantar', 'Hawa Mahal', 'Bazaar walk', 'Drop-off'] },
    ],
    destinations: ['Jaipur'],
    rating: '4.9',
    reviewCount: 143,
  ...
  },
  {
    ...
    slug: 'complete-rajasthan-grand-tour',
    description:
      'The definitive 14-day journey across Rajasthan — Jaipur, Pushkar, Udaipur, Jodhpur, Jaisalmer and Bikaner — covering every great fort, palace and desert experience.',
    longDescription:
      'This is the trip of a lifetime for travellers who want to truly experience Rajasthan. Over 14 unhurried days you’ll cross the whole state with a licensed local guide: the forts and bazaars of Jaipur, the holy lake of Pushkar, romantic lakeside Udaipur, the blue city of Jodhpur, camel safaris in the Jaisalmer desert, and the havelis of Bikaner. Refined over 5 years of guiding, the route is sequenced to minimise long drives, catch each fort at its best light, and mix headline sights with authentic village visits, local cuisine and heritage stays.',
    duration: 14,
    price: '74900',
    maxGroupSize: 14,
    category: 'heritage',
    ...
    highlights: [
      '🏰 Six iconic Rajasthan cities in one journey',
      '🐫 Camel safari & desert camp in Jaisalmer',
      '🛶 Lake Pichola boat ride in Udaipur',
      '🏛️ Mehrangarh, Amber & Junagarh forts',
      '🕌 Pushkar’s holy lake & Brahma Temple',
      '🍽️ Authentic regional cuisine throughout',
    ],
    included: [
      'Hotel accommodation (13 nights, heritage & 4★)',
      'Daily breakfast and dinner',
      'Air-conditioned private transport throughout',
      'Government-approved English-speaking guide',
      'All monument entry fees',
      'Jaisalmer camel safari & desert camp',
    ],
    excluded: [
      'Airfare / train tickets to Jaipur',
    ...
    itinerary: [
      { day: 1, title: 'Arrive Jaipur', description: 'Welcome to the Pink City.', activities: ['Airport pickup', 'Hotel check-in', 'Welcome dinner'] },
      { day: 2, title: 'Jaipur Sightseeing', description: 'Forts and palaces of Jaipur.', activities: ['Amber Fort', 'City Palace', 'Hawa Mahal', 'Jantar Mantar'] },
      { day: 3, title: 'Jaipur to Pushkar', description: 'The holy lake town.', activities: ['Brahma Temple', 'Pushkar Lake', 'Local bazaar'] },
      { day: 4, title: 'Pushkar to Udaipur', description: 'Drive to the City of Lakes.', activities: ['Scenic drive', 'Evening at leisure'] },
      { day: 5, title: 'Udaipur Sightseeing', description: 'Lakeside palaces.', activities: ['City Palace', 'Lake Pichola boat ride', 'Jagdish Temple'] },
      { day: 6, title: 'Udaipur to Ranakpur to Jodhpur', description: 'Marble temples en route.', activities: ['Ranakpur Jain Temple', 'Drive to Jodhpur'] },
      { day: 7, title: 'Jodhpur Sightseeing', description: 'The Blue City.', activities: ['Mehrangarh Fort', 'Jaswant Thada', 'Clock Tower market'] },
      { day: 8, title: 'Jodhpur to Jaisalmer', description: 'Into the desert.', activities: ['Long scenic drive', 'Evening at leisure'] },
      { day: 9, title: 'Jaisalmer Fort & Havelis', description: 'The living Golden Fort.', activities: ['Jaisalmer Fort', 'Patwon Ki Haveli', 'Gadisar Lake'] },
      { day: 10, title: 'Sam Sand Dunes', description: 'Camel safari & desert camp.', activities: ['Kuldhara Village', 'Camel safari', 'Folk evening', 'Overnight camp'] },
      { day: 11, title: 'Jaisalmer to Bikaner', description: 'Desert city of havelis.', activities: ['Drive to Bikaner', 'Junagarh Fort'] },
      { day: 12, title: 'Bikaner to Jaipur', description: 'Return towards Jaipur.', activities: ['Camel research farm', 'Scenic drive'] },
      { day: 13, title: 'Jaipur at Leisure', description: 'Shopping and free time.', activities: ['Bazaar shopping', 'Optional cooking class'] },
      { day: 14, title: 'Departure', description: 'Transfer for onward journey.', activities: ['Breakfast', 'Airport drop-off'] },
    ],
    destinations: ['Jaipur', 'Pushkar', 'Udaipur', 'Jodhpur', 'Jaisalmer', 'Bikaner'],
    rating: '4.9',
    reviewCount: 88,
    isActive: true,
    isFeatured: true,
  },
  {
    ...
    slug: 'jodhpur-jaisalmer-desert-trail',
    description:
      'A 6-day western Rajasthan journey through the Blue City of Jodhpur and the golden dunes of Jaisalmer, with a night under the stars at a desert camp.',
    longDescription:
      'Discover the wild, romantic west of Rajasthan. Stand atop the towering Mehrangarh Fort over Jodhpur’s indigo old town, wander spice markets, then head deep into the Thar Desert to Jaisalmer’s living sandstone fort and intricately carved havelis. The trip peaks with a camel and jeep safari across the Sam dunes and an overnight desert camp with folk music under a blanket of stars — a favourite of travellers who want forts and desert without a long multi-city marathon.',
    duration: 6,
    price: '27900',
    maxGroupSize: 12,
    category: 'desert',
    ...
    highlights: [
      '🏰 Mighty Mehrangarh Fort, Jodhpur',
      '💙 Blue City old town & markets',
      '🏜️ Sam sand dunes camel & jeep safari',
      '⭐ Overnight luxury desert camp',
      '🏛️ Jaisalmer Fort & Patwon Ki Haveli',
    ],
    included: [
      'Hotel + desert camp (5 nights)',
      'Daily breakfast & dinner',
      'Air-conditioned private transport',
      'Government-approved local guide',
      'Camel & jeep safari',
    ],
    excluded: [
      'Transport to Jodhpur',
      'Lunches & personal expenses',
      'Monument camera fees',
      'Tips & gratuities',
    ],
    itinerary: [
      { day: 1, title: 'Arrive Jodhpur', description: 'Welcome to the Blue City.', activities: ['Pickup', 'Hotel check-in', 'Clock Tower market'] },
      { day: 2, title: 'Jodhpur Sightseeing', description: 'Fort and old town.', activities: ['Mehrangarh Fort', 'Jaswant Thada', 'Blue City walk'] },
      { day: 3, title: 'Jodhpur to Jaisalmer', description: 'Drive into the desert.', activities: ['Scenic drive', 'Gadisar Lake sunset'] },
      { day: 4, title: 'Jaisalmer Fort & Havelis', description: 'The Golden City.', activities: ['Jaisalmer Fort', 'Patwon Ki Haveli', 'Bazaar'] },
      { day: 5, title: 'Sam Sand Dunes', description: 'Desert safari & camp.', activities: ['Kuldhara Village', 'Camel safari', 'Folk evening', 'Overnight camp'] },
      { day: 6, title: 'Departure', description: 'Transfer for onward journey.', activities: ['Breakfast', 'Drop-off'] },
    ],
    destinations: ['Jodhpur', 'Jaisalmer', 'Sam Dunes'],
    rating: '4.7',
    reviewCount: 112,
    isActive: true,
    isFeatured: false,
  ...
  {
    title: 'Ranthambore Tiger Safari & Jaipur',
    slug: 'ranthambore-tiger-safari-jaipur',
    description:
      'A 4-day wildlife and heritage escape combining tiger safaris in Ranthambore National Park with a guided day in the Pink City of Jaipur.',
    longDescription:
      'Pair the thrill of spotting a wild Bengal tiger with the royal splendour of Jaipur. Enjoy morning and afternoon jeep safaris through Ranthambore National Park — one of India’s best places to see tigers in the wild, set around a dramatic 10th-century fort and lakes — then transfer to Jaipur for a guided tour of Amber Fort, City Palace and Hawa Mahal. A compact, high-impact itinerary perfect for wildlife lovers, photographers and families.',
    duration: 4,
    price: '21900',
    maxGroupSize: 10,
    category: 'wildlife',
    ...
    itinerary: [
      { day: 1, title: 'Arrive Ranthambore', description: 'Transfer to the national park.', activities: ['Pickup', 'Hotel check-in', 'Briefing & dinner'] },
      { day: 2, title: 'Tiger Safaris', description: 'Morning & afternoon jeep safaris.', activities: ['Morning safari', 'Ranthambore Fort', 'Afternoon safari'] },
      { day: 3, title: 'Ranthambore to Jaipur', description: 'Drive to the Pink City.', activities: ['Drive to Jaipur', 'Evening bazaar'] },
      { day: 4, title: 'Jaipur & Departure', description: 'Guided city tour then departure.', activities: ['Amber Fort', 'City Palace', 'Hawa Mahal', 'Drop-off'] },
    ],
    destinations: ['Ranthambore', 'Jaipur'],
    rating: '4.7',
    reviewCount: 74,
    isActive: true,
    isFeatured: false,
