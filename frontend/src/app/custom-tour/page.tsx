            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <button type="button" onClick={() => setStep(3)} className="btn-primary flex-1">Next: Interests</button>
                </div>
              </div>
            )}
            ...
            {step === 3 && (
              <div className="space-y-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <button type="button" onClick={() => setStep(4)} className="btn-primary flex-1">Next: Contact Info</button>
                </div>
              </div>
            )}
