          ...
          <form onSubmit={handleSearch} className="bg-white rounded-2xl shadow-2xl p-4 md:p-6 lg:p-8">
            ...
            <div className="space-y-3 md:space-y-0 md:grid md:grid-cols-12 md:gap-3">
              ...
              <div className="md:col-span-3">
                <label className="block text-xs font-semibold text-gray-700 mb-2">Where to?</label>
            ...
            <div className="mt-4 md:mt-6 pt-4 md:pt-6 border-t border-gray-200">
              ...
              <div className="flex flex-wrap gap-2">
                <Link href="/tours?destination=golden-triangle" className="text-xs md:text-sm px-3 md:px-4 py-2 bg-gray-100 hover:bg-primary-50 text-gray-700 hover:text-primary-700 rounded-full transition-colors font-medium touch-manipulation min-h-[36px] flex items-center">
                  Golden Triangle
                </Link>
                <Link href="/tours?destination=jaipur" className="text-xs md:text-sm px-3 md:px-4 py-2 bg-gray-100 hover:bg-primary-50 text-gray-700 hover:text-primary-700 rounded-full transition-colors font-medium touch-manipulation min-h-[36px] flex items-center">
                  Jaipur City Tour
                </Link>
                <Link href="/tours?destination=jaisalmer" className="text-xs md:text-sm px-3 md:px-4 py-2 bg-gray-100 hover:bg-primary-50 text-gray-700 hover:text-primary-700 rounded-full transition-colors font-medium touch-manipulation min-h-[36px] flex items-center">
                  Desert Safari
                </Link>
                <Link href="/custom-tour" className="text-xs md:text-sm px-3 md:px-4 py-2 bg-gray-100 hover:bg-primary-50 text-gray-700 hover:text-primary-700 rounded-full transition-colors font-medium touch-manipulation min-h-[36px] flex items-center">
                  Custom Tour
                </Link>
              </div>
            </div>
