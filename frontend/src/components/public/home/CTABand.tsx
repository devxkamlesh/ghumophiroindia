    ...
    <section className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-primary-600 via-primary-700 to-orange-600">
        <div className="absolute inset-0 opacity-30" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.05'%3E%3Cpath d='M36 16c0-2.21 1.79-4 4-4s4 1.79 4 4-1.79 4-4 4-4-1.79-4-4zm0 24c0-2.21 1.79-4 4-4s4 1.79 4 4-1.79 4-4 4-4-1.79-4-4zM12 16c0-2.21 1.79-4 4-4s4 1.79 4 4-1.79 4-4 4-4-1.79-4-4zm0 24c0-2.21 1.79-4 4-4s4 1.79 4 4-1.79 4-4 4-4-1.79-4-4z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
        }} />
      </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            >
              <Link
                href="/custom-tour"
                className="group relative w-full sm:w-auto inline-flex items-center justify-center space-x-3 bg-white text-primary-600 hover:bg-yellow-50 px-10 py-5 rounded-2xl font-bold text-lg transition-all duration-300 shadow-2xl hover:scale-105 active:scale-100 overflow-hidden"
              >
